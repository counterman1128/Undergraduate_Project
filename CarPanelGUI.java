...
public class CarPanelGUI extends JPanel {
   ...
   private void setupCarPanel() {
      ...
      displayLabel.setBounds(153, 123, 93, 37);
      displayLabel.setFont(new Font("Verdana",1,15));
      displayLabel.setBackground(Color.BLACK);
      displayLabel.setForeground(Color.YELLOW);
      displayLabel.setOpaque(true);
      displayLabel.setHorizontalAlignment(SwingConstants.CENTER);
      this.add(displayLabel);
      this.setComponentZOrder(displayLabel, 1);
   ...
   public void doorOpenGif() {
      main_bg_opening.getImage().flush();
   ...
   public void doorCloseGif() {
	  main_bg_closing.getImage().flush();
   ...
   public void setDisplayTo(int f) {
      displayLabel.setText(Integer.toString(f));
   }
